...
namespace pinball
{
    public partial class Form1 : Form
    {
        ...
        {if(food.foodRec.IntersectsWith(baditem.baditemRec)) { baditem.baditemLocation(randBaditem); }
            ...
            if (bongbay.bongbayRec[0].X >= 280) { Restart(); }
            ...
            if (timer1.Enabled == true)
            {
                ...
                else if (bong.bongRec[0].X + 1 > 276 && s == 3) { s = 4; } else if (bong.bongRec[0].Y + 1 > 303 && s == 3) { Restart(); }
                ...
                else if (bong.bongRec[0].Y + 1 > 303 && s == 4) { Restart(); } else if (bong.bongRec[0].X - 1 < 1 && s == 4) { s = 3; }
            }
